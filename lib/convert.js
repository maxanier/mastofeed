...
function buildUp(jsonObj,opts){
  ...
  if(nextPageFeedUrl){
    jsonObj.nextPageLink = opts.prefix+opts.mastofeedUrl.replace(encodeURIComponent(opts.feedUrl),encodeURIComponent(nextPageFeedUrl));
    console.log(jsonObj.nextPageLink);
  }
  jsonObj.prefix=opts.prefix
